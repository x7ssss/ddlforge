...
[![Tests](https://img.shields.io/badge/Tests-900%2B%20passing-brightgreen.svg)](test)
...
Set your connection string in your shell or `.env` file:

```bash
export DATABASE_URL="postgresql://postgres:password@localhost:5432/mydb"
```

### 3. Verify Database Health & Archiving

Run the disaster recovery and WAL readiness doctor before running any major migrations:
...
```text
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ddlforge v2.0.0 — Continuous WAL Archiving & Disaster Readiness Doctor
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
Run your migration with autonomous lock pre-emption and automatic lock-queue cancellation:
...
ℹ cancelled 0
ℹ skipped 0
ℹ duration_ms 2450.12
```

- **Zero dependencies** for static linting (`ddlforge check`).
- **Sub-15 millisecond** AST analysis across 100+ migration files.
- **900+ tests** verifying lock taxonomies, partition state machines, and replication mesh cutovers.
